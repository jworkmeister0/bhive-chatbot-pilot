...
module.exports = function(){
    ...
    var messagaingEventHandler = {
        onMessage: function(){
            ...
            if (isEcho){
                console.log("Recieved echo for message %s and app %d with metatdata %s", messageID, quickReplyPayload);
            }
            ...
            if (messageText) {
                ...
                sendTextMessage(senderID, "Message with attachment recieved");
            }
        },

        onDeliveryConfirmation: function(){
            var senderID = event.sender.id;
            var recipientID = event.recipient.id;
            var delivery = evetn.delivery;
